...
head.ready(function() {
	...
	var Default = {
		utils : {
			...
			forms : function(){
				$('.form-a label:not(.hidden) + :input:not(select,button)').each(function(){
			...
			top : function(){
				$('#top').append('<div class="menu"><div class="a"></div><div class="b"></div><div class="c"></div></div>');
				$('#nav > ul > li > ul').before('<span class="toggle"></span>').parent().addClass('sub');
